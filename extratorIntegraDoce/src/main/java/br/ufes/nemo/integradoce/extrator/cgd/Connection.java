...
public class Connection {
	...
	public Connection(String server, String dataBase, String username, String password) {
		...
		this.connectionConfig = ConnectionConfiguration.to(dataBase).server(server).credentials(username, password);
	}
	...
	public Connection(String server, String dataBase) {
		...
		try {
			this.connectionConfig = ConnectionConfiguration.to(dataBase).server(server).credentials(this.username,
					this.password);
		} catch (Exception e) {
